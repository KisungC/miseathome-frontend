        ...
        <nav
            ...
            <div className="flex w-full flex-row items-center justify-between px-3">
                ...
                <div className="w-full flex justify-end">
                    ...
                    <button className="bg-transparent hover:bg-[#FFB700] text-primary font-semibold cursor-pointer hover:text-white py-2 px-4 border border-primary hover:border-transparent rounded" onClick={handleLogin}>
                        Login
                    </button>
                </div>
            </div>
